  ...
  return (
    <div className="h-screen w-screen gradient-bg overflow-hidden relative font-sans text-white">
        ...
        <AnimatePresence mode="wait">
          {!user ? (
            ...
            >
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-blue-100/60 mb-10 font-medium tracking-tight max-w-3xl mx-auto leading-relaxed px-4">
                The world's most advanced AI Knowledge Assistant for professional document analysis, troubleshooting, and client-facing intelligence.
              </p>
              ...
              <div className="mt-16 sm:mt-24 grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12 px-4">
                {[
                  ...
                  { icon: Rocket, label: 'Neural AI Engine' }
                ].map((item, i) => (
                  <motion.div 
                    key={i}
            ...
            >
              ...
              <p className="text-blue-200/60 text-lg sm:text-2xl mb-12 font-medium px-4">Your professional AI assistant is ready for deployment.</p>
      ...
      <div className="hidden sm:flex absolute top-10 left-10 items-center gap-4 glass-premium px-4 py-2 rounded-full">
        ...
        <span className="text-blue-400 text-[10px] font-black tracking-[0.3em] uppercase">GaruanCDX Core v2.5</span>
      </div>
      
      <div className="hidden sm:block absolute bottom-10 right-10 text-blue-200/20 text-[10px] font-bold tracking-widest uppercase">
        © 2026 GaruanCDX Intelligence Systems • All Rights Reserved
      </div>
    </div>
  );
}
